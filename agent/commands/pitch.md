---
description: Generate a tailored outreach pitch for a job application
---
Generate a tailored outreach/pitch message for a job application.

Use this when the user provides a company and job posting. If either is missing, ask for it.

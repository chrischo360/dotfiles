-- Hammerspoon Slack - Focus Management
-- Based on: https://github.com/dbalatero/dotfiles/blob/main/hammerspoon/slack/focus.lua
--
-- This module provides functions to focus specific UI elements in Slack
...
-- Focus the main message input box (left pane)
...
-- Focus the thread message input box (right pane)
module.threadMessageBox = function(withRetry)
  ...
  if withRetry then
    -- Do it in a retry loop (for when thread pane is opening)
